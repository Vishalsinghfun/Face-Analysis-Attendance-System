...
class Register:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"D:\Private\Python_Test_Projects\Images_GUI\register.jpg")
        ...
        # img1=Image.open(r"D:\Private\Python_Test_Projects\Images_GUI\reg1.png")
        ...
        get_str = Label(frame,text="Admin Registration Portal",font=("times new roman",30,"bold"),fg="#000000",bg="#FFFFFF")
        get_str.place(x=220,y=130)

        #label1 
        fname =lb1= Label(frame,text="First Name:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label2 
        lname =lb1= Label(frame,text="Last Name:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label1 
        cnum =lb1= Label(frame,text="Contact No:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label2 
        email =lb1= Label(frame,text="Email:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label1 
        ssq =lb1= Label(frame,text="Select Security Question:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label2 
        sa =lb1= Label(frame,text="Security Answer:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label1 
        pwd =lb1= Label(frame,text="Password:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        #label2 
        cpwd =lb1= Label(frame,text="Confirm Password:",font=("times new roman",15,"bold"),fg="#000000",bg="#FFFFFF")
        ...
        # Checkbutton
        checkbtn = Checkbutton(frame,variable=self.var_check,text="I Agree the Terms & Conditions",font=("times new roman",13,"bold"),fg="#000000",bg="#FFFFFF")
        checkbtn.place(x=100,y=480,width=270)


        # Creating Button Register
        loginbtn=Button(frame,command=self.reg,text="Register",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="violetred1",activeforeground="white",activebackground="#000000")
        loginbtn.place(x=103,y=510,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,command=self.return_login,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="violetred1",activeforeground="white",activebackground="#000000")
    ...
    def reg(self):
        if (self.var_fname.get()=="" or self.var_lname.get()=="" or self.var_cnum.get()=="" or self.var_email.get()=="" or self.var_ssq.get()=="Select" or self.var_sa.get()=="" or self.var_pwd.get()=="" or self.var_cpwd.get()==""):
            ...
            # messagebox.showinfo("Successfully","Successfully Registerd!")
            try:
                ...
                if row!=None:
                    ...
                    conn.commit()
                    conn.close()
                    messagebox.showinfo("Registration Complete","Successfully Registerd!",parent=self.root)
