...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # backgorund image 
        bg1=Image.open(r"Images_GUI\pannel1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome To Attendance Monitoring Panel",font=("verdana",30,"bold"),bg="white",fg="black")
        ...
        #Student id
        studentId_label = Label(left_frame,text="User-ID:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Studnet Name
        student_name_label = Label(left_frame,text="Student-Name:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Improt button
        save_btn=Button(btn_frame,command=self.importCsv,text="Import CSV",width=12,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        save_btn.grid(row=0,column=0,padx=6,pady=10,sticky=W)

        #Exprot button
        update_btn=Button(btn_frame,command=self.exportCsv,text="Export CSV",width=12,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        update_btn.grid(row=0,column=1,padx=6,pady=8,sticky=W)

        #Update button
        del_btn=Button(btn_frame,command=self.action,text="Update",width=12,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=12,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
    ...
    #Update button
        del_btn=Button(right_frame,command=self.update_data,text="Update",width=12,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        del_btn.grid(row=0,column=1,padx=6,pady=10,sticky=W)
    #Update button
        del_btn=Button(right_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)
