...
class Student:
    ...
    # This part is image labels setting start 
        # first header image  
        img=Image.open(r"D:\Private\Python_Test_Projects\Images_GUI\pannel.jpg")
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"D:\Private\Python_Test_Projects\Images_GUI\pannel1.jpg")
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Student Portal",font=("verdana",30,"bold"),bg="white",fg="black")
        ...
        cou_combo["values"]=("Select Course","Information Technology","Computer Science","Accounting & Finance","Banking & Insurance","Business Management","English Literature","History","Economics")
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Semester","SEM-I","SEM-II","SEM-III","SEM-IV","SEM-V","SEM-VI")
        year_combo.current(0)
        ...
        #Student id
        studentId_label = Label(class_Student_frame,text="User-ID:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Student-Name:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Teacher Name:",font=("verdana",12,"bold"),fg="black",bg="white")
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=7,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=7,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=7,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,text="Update Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,font=("verdana",12,"bold"),fg="white",bg="violetred1",activeforeground="white",activebackground="#0f0f0f")
...
# ==================Function Decleration==============================
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            messagebox.showerror("Error","Select roll-no option and enter entry box",parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(username='root', password='conor@2012',host='localhost',database='face_recognition',port=3306)
            ...
            try:
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        img_id+=1
                        face=cv2.resize(face_croped(my_frame),(350,350))
